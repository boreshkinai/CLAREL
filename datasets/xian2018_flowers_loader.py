...
class Xian2018FlowersLoader(Dataset):
    """
    Loads the CVPR2016-FLOWERS dataset with the features proposed in https://www.mpi-inf.mpg.de/departments/computer-vision-and-multimodal-computing/research/zero-shot-learning/feature-generating-networks-for-zero-shot-learning/
    """

    def __init__(self, data_dir: str = DEFAULT_DIR, flowers_dir: str = DEFAULT_FLOWERS_DIR, split: str = "train",
        ...
        :param flowers_dir: the folder inside the main dataset where the original FLOWERS images are stored
        ...
        self.cvpr18xian_dir = os.path.join(self.data_dir, "cvpr18xian", "data", "FLO")
        self.split = split
    ...
    def load_cached(self):
        logging.info('Loading split %s' % self.split)
        cache_filepath = os.path.join(self.data_dir, 'split_' + self.split + '_xian2018.pkl')
    ...
    def _load_image_features(self):
        image_features_path = os.path.join(self.cvpr18xian_dir, "res101.mat")
    ...
    def _build_vocabulary(self, vocab_size=10000):
        ...
        all_loader = Xian2018FlowersLoader(data_dir=self.data_dir, flowers_dir=self.flowers_dir, split='all')
